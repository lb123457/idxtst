...
class FileComparator(object):
    ...
    def __init__(self, file1, file2, **kwargs):
        ...
        self.df_file1 = ioutils.load_file(file1)
        self.df_file2 = ioutils.load_file(file2)

        self.df_comparator = dfutils.DFComparator(self.df_file1, self.df_file2)
